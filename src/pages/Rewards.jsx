...
const Rewards = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="max-w-screen-lg mx-auto flex flex-col items-start ml-40">
          <h1>FREE COFFEE</h1>
          <h1>IS A TAP AWAY</h1>
        ...
        <div className="max-w-screen-lg mx-auto flex flex-col justify-center items-center">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-4">
              <div
                onClick={() => handleStarClick('25★Stars')}
                className={`cursor-pointer ${
                  selectedStar === '25★Stars'
                    ? 'font-bold text-green-600 text-[20px] hover:underline underline-offset-8'
                    : 'text-gray-500 text-[20px] hover:text-green-600'
                }`}
              >
                25★
              </div>
              <div
                onClick={() => handleStarClick('100★Stars')}
                className={`cursor-pointer ${
                  selectedStar === '100★Stars'
                    ? 'font-bold text-green-600 text-[20px] hover:underline underline-offset-8'
                    : 'text-gray-500 text-[20px] hover:text-green-600'
                }`}
              >
              ...
              <div
                onClick={() => handleStarClick('200★Stars')}
                className={`cursor-pointer ${
                  selectedStar === '200★Stars'
                    ? 'font-bold text-green-600 text-[20px] hover:underline underline-offset-8'
                    : 'text-gray-500 text-[20px] hover:text-green-600'
                }`}
              >
              ...
              <div
                onClick={() => handleStarClick('300★Stars')}
                className={`cursor-pointer ${
                  selectedStar === '300★Stars'
                    ? 'font-bold text-green-600 text-[20px] hover:underline underline-offset-8'
                    : 'text-gray-500 text-[20px] hover:text-green-600'
                }`}
              >
              ...
              <div
                onClick={() => handleStarClick('400★Stars')}
                className={`cursor-pointer ${
                  selectedStar === '400★Stars'
                    ? 'font-bold text-green-600 text-[20px] hover:underline underline-offset-8'
                    : 'text-gray-500 text-[20px] hover:text-green-600'
                }`}
              >
          ...
          {selectedStar && (
            <div className="flex justify-center items-center bg-light-green p-6 rounded-lg shadow-md">
              <img
                src={
                  selectedStar === '25★Stars'
                    ? star25
              ...
              />
              <p className="text-gray-700">
                Customize your drink. Make your drink just right with an extra
                espresso shot, nondairy milk, or a dash of your favorite syrup.
              </p>
            </div>
          )}
        </div>
